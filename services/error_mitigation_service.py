"""DEPRECATED DUPLICATE — do not import. See src/error_mitigation_service/service.py.
...
"""
raise ImportError(
    "services/error_mitigation_service.py is a deprecated duplicate that still fabricates "
    "its results. Import from src.error_mitigation_service.service instead. "
    "See SCAFFOLDING.md.")
