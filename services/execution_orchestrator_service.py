"""DEPRECATED DUPLICATE — do not import. See src/execution_orchestrator_service/service.py.
...
"""
raise ImportError(
    "services/execution_orchestrator_service.py is a deprecated duplicate that still fabricates "
    "its results. Import from src.execution_orchestrator_service.service instead. "
    "See SCAFFOLDING.md.")
