"""DEPRECATED DUPLICATE — do not import. See src/problem_definition_service/service.py.
...
"""
raise ImportError(
    "services/problem_definition_service.py is a deprecated duplicate that still fabricates "
    "its results. Import from src.problem_definition_service.service instead. "
    "See SCAFFOLDING.md.")
