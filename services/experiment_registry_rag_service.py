"""DEPRECATED DUPLICATE — do not import. See src/experiment_registry_rag_service/service.py.
...
"""
raise ImportError(
    "services/experiment_registry_rag_service.py is a deprecated duplicate that still fabricates "
    "its results. Import from src.experiment_registry_rag_service.service instead. "
    "See SCAFFOLDING.md.")
